...
{
    internal partial class Form1095COperations : IServiceOperations<BoomTaxApi>, IForm1095COperations
    {
        /// <summary>
        /// Initializes a new instance of the Form1095COperations class.
        /// </summary>
        /// <param name='client'>
        /// Reference to the service client.
        /// </param>
        internal Form1095COperations(BoomTaxApi client)
        {
            this._client = client;
        }
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<Form1095C>> GetWithOperationResponseAsync(int id, CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Tracing
            bool shouldTrace = ServiceClientTracing.IsEnabled;
            string invocationId = null;
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<int>> PostWithOperationResponseAsync(int filingId, Form1095C form1095C, CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Validate
            if (form1095C == null)
            {
